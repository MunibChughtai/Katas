...
def test_superRatePositiveTest(classInitialized):
    ...
    assert classInitialized.getSuperRate() == 9
    classInitialized.setSuperRate(0)
    assert classInitialized.getSuperRate() == 0
    classInitialized.setSuperRate(50)
    assert classInitialized.getSuperRate() == 50
...
def test_payment_date(classInitialized):
    classInitialized.setDateRange('1 March - 31 March')
    assert classInitialized.getDateRange() == '1 March - 31 March'
...
def test_AddEmployeeDatatoDict(classInitialized):
    ...
    assert classInitialized.getSuper() == classInitialized.getSuper('JohnDoe')
